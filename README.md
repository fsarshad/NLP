...
2. [Overview](#Overview)
3. [Methods](#Methods)
    * [Model 1: Conv1D Model](#Model-1:-Conv1D-Model)
    * [Model 2: Transfer Learning with GloVe Embeddings](#Model-2:-Transfer-Learning-with-GloVe-Embeddings)
    * [Model 3: Transfer Learning with BERT](#Model-3:-Transfer-Learning-with-BERT)
4. [Results](#Results)
